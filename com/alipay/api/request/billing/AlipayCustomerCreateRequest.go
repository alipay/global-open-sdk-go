...
type AlipayCustomerCreateRequest struct {
...
func NewAlipayCustomerCreateRequest() (*request.AlipayRequest, *AlipayCustomerCreateRequest) {
	alipayCustomerCreateRequest := &AlipayCustomerCreateRequest{}
	alipayRequest := request.NewAlipayRequest(alipayCustomerCreateRequest, "/ams/api/v1/billing/customer/create", &responseBilling.AlipayCustomerCreateResponse{})
	return alipayRequest, alipayCustomerCreateRequest
}

func (alipayCustomerCreateRequest *AlipayCustomerCreateRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayCustomerCreateRequest, "/ams/api/v1/billing/customer/create", &responseBilling.AlipayCustomerCreateResponse{})
}
