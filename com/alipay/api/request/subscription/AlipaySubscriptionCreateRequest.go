...
func NewAlipaySubscriptionCreateRequest() (*request.AlipayRequest, *AlipaySubscriptionCreateRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipaySubscriptionCreateRequest, "", &responseSubscription.AlipaySubscriptionCreateResponse{})
...
func (alipaySubscriptionCreateRequest *AlipaySubscriptionCreateRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipaySubscriptionCreateRequest, "", &responseSubscription.AlipaySubscriptionCreateResponse{})
}
