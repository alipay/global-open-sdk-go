...
func NewAlipaySubscriptionCancelRequest() (*request.AlipayRequest, *AlipaySubscriptionCancelRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipaySubscriptionCancelRequest, "", &responseSubscription.AlipaySubscriptionCancelResponse{})
...
func (alipaySubscriptionCancelRequest *AlipaySubscriptionCancelRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipaySubscriptionCancelRequest, "", &responseSubscription.AlipaySubscriptionCancelResponse{})
}
