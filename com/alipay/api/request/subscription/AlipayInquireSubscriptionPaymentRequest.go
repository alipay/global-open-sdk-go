...
func NewAlipayInquireSubscriptionPaymentRequest() (*request.AlipayRequest, *AlipayInquireSubscriptionPaymentRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireSubscriptionPaymentRequest, "", &responseSubscription.AlipayInquireSubscriptionPaymentResponse{})
...
func (alipayInquireSubscriptionPaymentRequest *AlipayInquireSubscriptionPaymentRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireSubscriptionPaymentRequest, "", &responseSubscription.AlipayInquireSubscriptionPaymentResponse{})
}
