...
func NewAlipayInquireSubscriptionRequest() (*request.AlipayRequest, *AlipayInquireSubscriptionRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireSubscriptionRequest, "/ams/api/v1/subscriptions/inquireSubscription", &responseSubscription.AlipayInquireSubscriptionResponse{})
...
func (alipayInquireSubscriptionRequest *AlipayInquireSubscriptionRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireSubscriptionRequest, "/ams/api/v1/subscriptions/inquireSubscription", &responseSubscription.AlipayInquireSubscriptionResponse{})
}
