...
func NewAlipayDownloadDisputeEvidenceRequest() (*request.AlipayRequest, *AlipayDownloadDisputeEvidenceRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayDownloadDisputeEvidenceRequest, "", &responseDispute.AlipayDownloadDisputeEvidenceResponse{})
...
func (alipayDownloadDisputeEvidenceRequest *AlipayDownloadDisputeEvidenceRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayDownloadDisputeEvidenceRequest, "", &responseDispute.AlipayDownloadDisputeEvidenceResponse{})
}
