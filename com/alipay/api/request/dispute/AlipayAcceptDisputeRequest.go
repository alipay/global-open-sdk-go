...
func NewAlipayAcceptDisputeRequest() (*request.AlipayRequest, *AlipayAcceptDisputeRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayAcceptDisputeRequest, "", &responseDispute.AlipayAcceptDisputeResponse{})
...
func (alipayAcceptDisputeRequest *AlipayAcceptDisputeRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayAcceptDisputeRequest, "", &responseDispute.AlipayAcceptDisputeResponse{})
}
