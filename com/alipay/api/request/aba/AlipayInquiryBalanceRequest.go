...
func NewAlipayInquiryBalanceRequest() (*request.AlipayRequest, *AlipayInquiryBalanceRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquiryBalanceRequest, "/ams/api/v1/aba/accounts/inquiryBalance", &responseAba.AlipayInquiryBalanceResponse{})
...
func (alipayInquiryBalanceRequest *AlipayInquiryBalanceRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquiryBalanceRequest, "/ams/api/v1/aba/accounts/inquiryBalance", &responseAba.AlipayInquiryBalanceResponse{})
}
