...
func NewAlipayInquireDirectPaymentRequest() (*request.AlipayRequest, *AlipayInquireDirectPaymentRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireDirectPaymentRequest, "/ams/aba/funds/inquireDirectPayment", &responseAba.AlipayInquireDirectPaymentResponse{})
...
func (alipayInquireDirectPaymentRequest *AlipayInquireDirectPaymentRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireDirectPaymentRequest, "/ams/aba/funds/inquireDirectPayment", &responseAba.AlipayInquireDirectPaymentResponse{})
}
