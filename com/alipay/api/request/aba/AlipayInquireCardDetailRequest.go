...
func NewAlipayInquireCardDetailRequest() (*request.AlipayRequest, *AlipayInquireCardDetailRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireCardDetailRequest, "", &responseAba.AlipayInquireCardDetailResponse{})
...
func (alipayInquireCardDetailRequest *AlipayInquireCardDetailRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireCardDetailRequest, "", &responseAba.AlipayInquireCardDetailResponse{})
}
