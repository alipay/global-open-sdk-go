...
func NewAlipayUpdateCardStatusRequest() (*request.AlipayRequest, *AlipayUpdateCardStatusRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayUpdateCardStatusRequest, "", &responseAba.AlipayUpdateCardStatusResponse{})
...
func (alipayUpdateCardStatusRequest *AlipayUpdateCardStatusRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayUpdateCardStatusRequest, "", &responseAba.AlipayUpdateCardStatusResponse{})
}
