...
func NewAlipayInquiryStatementListRequest() (*request.AlipayRequest, *AlipayInquiryStatementListRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquiryStatementListRequest, "", &responseAba.AlipayInquiryStatementListResponse{})
...
func (alipayInquiryStatementListRequest *AlipayInquiryStatementListRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquiryStatementListRequest, "", &responseAba.AlipayInquiryStatementListResponse{})
}
