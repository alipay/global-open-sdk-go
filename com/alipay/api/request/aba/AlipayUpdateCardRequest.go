...
func NewAlipayUpdateCardRequest() (*request.AlipayRequest, *AlipayUpdateCardRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayUpdateCardRequest, "", &responseAba.AlipayUpdateCardResponse{})
...
func (alipayUpdateCardRequest *AlipayUpdateCardRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayUpdateCardRequest, "", &responseAba.AlipayUpdateCardResponse{})
}
