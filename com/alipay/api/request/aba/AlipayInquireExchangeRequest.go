...
func NewAlipayInquireExchangeRequest() (*request.AlipayRequest, *AlipayInquireExchangeRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireExchangeRequest, "", &responseAba.AlipayInquireExchangeResponse{})
...
func (alipayInquireExchangeRequest *AlipayInquireExchangeRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireExchangeRequest, "", &responseAba.AlipayInquireExchangeResponse{})
}
