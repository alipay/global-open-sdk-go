...
func NewAlipayInquireAvailableQuotaRequest() (*request.AlipayRequest, *AlipayInquireAvailableQuotaRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireAvailableQuotaRequest, "/ams/api/v1/aba/account/inquireAvailableQuota", &responseAba.AlipayInquireAvailableQuotaResponse{})
...
func (alipayInquireAvailableQuotaRequest *AlipayInquireAvailableQuotaRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireAvailableQuotaRequest, "/ams/api/v1/aba/account/inquireAvailableQuota", &responseAba.AlipayInquireAvailableQuotaResponse{})
}
