...
func NewAlipayInquireAvailableQuotaRequest() (*request.AlipayRequest, *AlipayInquireAvailableQuotaRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireAvailableQuotaRequest, "", &responseAba.AlipayInquireAvailableQuotaResponse{})
...
func (alipayInquireAvailableQuotaRequest *AlipayInquireAvailableQuotaRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireAvailableQuotaRequest, "", &responseAba.AlipayInquireAvailableQuotaResponse{})
}
