...
func NewAlipayCreateDirectPaymentRequest() (*request.AlipayRequest, *AlipayCreateDirectPaymentRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayCreateDirectPaymentRequest, "/ams/aba/funds/createDirectPayment", &responseAba.AlipayCreateDirectPaymentResponse{})
...
func (alipayCreateDirectPaymentRequest *AlipayCreateDirectPaymentRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayCreateDirectPaymentRequest, "/ams/aba/funds/createDirectPayment", &responseAba.AlipayCreateDirectPaymentResponse{})
}
