...
func NewAlipayInquireDirectRefundRequest() (*request.AlipayRequest, *AlipayInquireDirectRefundRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquireDirectRefundRequest, "/ams/api/v1/aba/funds/inquireDirectRefund", &responseAba.AlipayInquireDirectRefundResponse{})
...
func (alipayInquireDirectRefundRequest *AlipayInquireDirectRefundRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquireDirectRefundRequest, "/ams/api/v1/aba/funds/inquireDirectRefund", &responseAba.AlipayInquireDirectRefundResponse{})
}
