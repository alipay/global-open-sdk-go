...
func NewAlipayCreateTransferRequest() (*request.AlipayRequest, *AlipayCreateTransferRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayCreateTransferRequest, "/ams/api/v1/aba/funds/createTransfer", &responseMarketplace.AlipayCreateTransferResponse{})
...
func (alipayCreateTransferRequest *AlipayCreateTransferRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayCreateTransferRequest, "/ams/api/v1/aba/funds/createTransfer", &responseMarketplace.AlipayCreateTransferResponse{})
}
