...
func NewAlipayAuthConsultRequest() (*request.AlipayRequest, *AlipayAuthConsultRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayAuthConsultRequest, "", &responseAuth.AlipayAuthConsultResponse{})
...
func (alipayAuthConsultRequest *AlipayAuthConsultRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayAuthConsultRequest, "", &responseAuth.AlipayAuthConsultResponse{})
}
