...
func NewAlipayPaymentSessionRequest() (*request.AlipayRequest, *AlipayPaymentSessionRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayPaymentSessionRequest, "", &responsePay.AlipayPaymentSessionResponse{})
...
func (alipayPaymentSessionRequest *AlipayPaymentSessionRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayPaymentSessionRequest, "", &responsePay.AlipayPaymentSessionResponse{})
}
