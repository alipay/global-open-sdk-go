...
func NewAlipayInquiryRefundRequest() (*request.AlipayRequest, *AlipayInquiryRefundRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayInquiryRefundRequest, "", &responsePay.AlipayInquiryRefundResponse{})
...
func (alipayInquiryRefundRequest *AlipayInquiryRefundRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayInquiryRefundRequest, "", &responsePay.AlipayInquiryRefundResponse{})
}
