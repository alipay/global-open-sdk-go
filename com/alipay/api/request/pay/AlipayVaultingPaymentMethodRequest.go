...
func NewAlipayVaultingPaymentMethodRequest() (*request.AlipayRequest, *AlipayVaultingPaymentMethodRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayVaultingPaymentMethodRequest, "", &responsePay.AlipayVaultingPaymentMethodResponse{})
...
func (alipayVaultingPaymentMethodRequest *AlipayVaultingPaymentMethodRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayVaultingPaymentMethodRequest, "", &responsePay.AlipayVaultingPaymentMethodResponse{})
}
