...
func NewAlipayPayQueryRequest() (*request.AlipayRequest, *AlipayPayQueryRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayPayQueryRequest, "", &responsePay.AlipayPayQueryResponse{})
...
func (alipayPayQueryRequest *AlipayPayQueryRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayPayQueryRequest, "", &responsePay.AlipayPayQueryResponse{})
}
