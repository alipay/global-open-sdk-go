...
func NewAlipayVaultingSessionRequest() (*request.AlipayRequest, *AlipayVaultingSessionRequest) {
	...
	alipayRequest := request.NewAlipayRequest(alipayVaultingSessionRequest, "", &responsePay.AlipayVaultingSessionResponse{})
...
func (alipayVaultingSessionRequest *AlipayVaultingSessionRequest) NewRequest() *request.AlipayRequest {
	return request.NewAlipayRequest(&alipayVaultingSessionRequest, "", &responsePay.AlipayVaultingSessionResponse{})
}
