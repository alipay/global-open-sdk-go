...
type PaymentResultInfo struct {
	...
	IncrementalAuthorizationAvailable bool           `json:"incrementalAuthorizationAvailable,omitempty"`
	ExtendedAuthorizationAvailable    bool           `json:"extendedAuthorizationAvailable,omitempty"`
	RefundOnAuthorizationAvailable    bool           `json:"refundOnAuthorizationAvailable,omitempty"`
}
